...
![Both S3 buckets created by the stack](s3 buckets.png)
...
![The Bedrock Agent, created and prepared](bedrock agent.png)
...
![Agent returning the customer record successfully](simple test.png)
...
![The vulnerable IAM role with AmazonS3FullAccess attached](tool access.png)
...
![Agent response confirming the deletion](deleted files.png)
...
![The empty backups bucket after the attack](no objects left.png)
...
![Full agent overview and detail view](test the agent.png)
...
![The seed-data role's correctly-scoped policy, for contrast](permissions in policy.png)
...
| `README.md` | This file |
| Screenshots (*.png) | Screenshots referenced above — vulnerable role, attack, damage, and supplementary views |
