...
![Both S3 buckets created by the stack](02-s3-buckets-list.png)
...
![The Bedrock Agent, created and prepared](03-agent-created.png)
...
![Agent returning the customer record successfully](05-baseline-query-response.png)
...
![The vulnerable IAM role with AmazonS3FullAccess attached](06-vulnerable-iam-role-s3fullaccess.png)
...
![Agent response confirming the deletion](07-attack-response-deleted.png)
...
![The empty backups bucket after the attack](08-empty-bucket.png)
...
![Full agent overview and detail view](09-agent-overview-detail.png)
...
![The seed-data role's correctly-scoped policy, for contrast](10c-seed-policy-json.png)
...
| `README.md` | This file |
| `` | Screenshots referenced above — vulnerable role, attack, damage, and supplementary views (fixed-half screenshots to be added) |
